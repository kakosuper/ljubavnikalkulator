class AstroEngine {
  ...
  // FUNKCIJA ZA NORMALIZACIJU: Pretvara ćirilicu u latinicu pre računanja
  ...
  static int calculateNameMatch(String name1, String name2) {
    ...
    // Balansiranje da rezultati ne budu previše niski
  ...
  // DRUGI DEO: Logika za Horoskop (Znakovi)
  ...
  // TREĆI DEO: Logika za Podznak (Ascendant)
  static String calculateAscendant(DateTime date, int hour, int minute) {
    ...
    // Aproksimacija pomeranja podznaka na svakih 2 sata zavisno od meseca
  ...
  // ČETVRTI DEO: Finalni procenat ljubavi
  static int getFinalScore({
    ...
    // Ako su isti znakovi, skor je visok, inače je solidnih 75
